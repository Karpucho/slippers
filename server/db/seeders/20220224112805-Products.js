module.exports = {
  up: async (queryInterface) => {
    await queryInterface.bulkInsert('Products', [
      {
        name: 'ROSSI', categoryId: 1, gender: 'female', description: 'Шлепанцы бежевые', photo: 'https://images.unsplash.com/photo-1549298916-b41d501d3772?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1112&q=80', rating: 4, price: 1990, status: 'active', createdAt: new Date(), updatedAt: new Date(),
      },
      {
